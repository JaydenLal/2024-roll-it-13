...
dice is a double (eg: both dice show a three), then your score 
 will be DOUBLE the number of points (but only if you win).

 If you lose the round, then you don't get any points.

 If you and the computer tie (eg: you both get a score of 11), 
 then you will have 11 points added to your score.  If your first 
 roll was a double and you tie, you don't get double points.
